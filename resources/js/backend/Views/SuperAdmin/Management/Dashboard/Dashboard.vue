            ...
            <div class="bottom-row">
                ...
                <div class="glass-card enroll-panel">
                    <div class="card-head">
                        ...
                        <span class="card-head-title"
                            >Recent Live Course Enrollments</span
                        >
                        <router-link
                            :to="{ name: 'AllLiveCourseEnrollment' }"
                            class="view-all-link"
                ...
                <div class="right-col">
                    ...
                    <div class="glass-card msg-panel">
                        ...
                        <div class="msg-list">
                            ...
                            <div
                                v-for="m in data.recent_messages"
                                :key="m.id"
                                class="msg-row"
                            >
                                <div
    ...
    methods: {
        ...
        strColor(name) {
            ...
            for (let i = 0; i < (name || "").length; i++)
                h = (name.charCodeAt(i) + h * 31) & 0xffffffff;
    ...
    computed: {
        stat_cards() {
            ...
            return [
                ...
                {
                    label: "Live Courses",
                    value: d.total_live_courses ?? 0,
                    icon: "fa-solid fa-chalkboard-user",
                    color: "#8b5cf6",
                },
                {
                    label: "Recorded Courses",
                    value: d.total_recorded_courses ?? 0,
                    icon: "fa-solid fa-video",
                    color: "#10b981",
                },
                {
                    label: "Live Enrollments",
                    value: d.total_live_enrollments ?? 0,
                    icon: "fa-solid fa-user-graduate",
                    color: "#f97316",
                },
                {
                    label: "Recorded Enroll.",
                    value: d.total_recorded_enrollments ?? 0,
                    icon: "fa-solid fa-circle-play",
                    color: "#06b6d4",
                },
                {
                    label: "Live Revenue (৳)",
                    value: Number(d.live_revenue ?? 0).toLocaleString(),
                    icon: "fa-solid fa-bangladeshi-taka-sign",
                    color: "#22c55e",
                },
                {
                    label: "Pending",
                    value: d.pending_live_enrollments ?? 0,
                    icon: "fa-solid fa-clock",
                    color: "#eab308",
                },
                {
                    label: "Messages",
                    value: d.total_messages ?? 0,
