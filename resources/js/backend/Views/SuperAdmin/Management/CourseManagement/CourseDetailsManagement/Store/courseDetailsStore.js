    ...
    getters: {
        ...
        hasFormChanges: (state) => {
            return Object.keys(state.formData).some((key) => {
                return (
                    state.formData[key] !== (state.currentCourse?.[key] || "")
                );
            });
        },
    ...
    actions: {
        ...
        async getCourseDetails(slug) {
            ...
            try {
                ...
                this.errorMessage =
                    "কোর্সের বিস্তারিত তথ্য লোড করতে ত্রুটি হয়েছে";
        ...
        async destroyCourse(slug) {
            ...
            try {
                ...
                this.errorMessage =
                    "কোর্স স্থায়ীভাবে মুছে ফেলতে ত্রুটি হয়েছে";
        ...
        populateFormWithCourse(course) {
            this.formData = {
                ...
                is_published:
                    course.is_published !== undefined ? course.is_published : 0,
                regular_price: course.regular_price || null,
                sales_price: course.sales_price || null,
