        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">
                    ...
                    {{ isEditMode ? 'Edit Will Get Item' : 'Create New Will Get Item' }}
                </h5>
            </div>
            <div class="card-body">
...
export default {
    ...
    computed: {
        ...
        isEditMode() {
            return this.$route.name === 'CourseWhatGetEdit' && this.$route.params.slug;
        },
    ...
    methods: {
        ...
        async loadItemData() {
            ...
            try {
                ...
                const response = await axios.get(`course-what-you-will-gets/${itemSlug}`);
        ...
        async submitForm() {
            ...
            try {
                ...
                if (this.isEditMode) {
                    const itemSlug = this.itemSlug; // This contains the slug from route params
                    response = await axios.post(`course-what-you-will-gets/update/${itemSlug}`, itemData);
                } else {
                    response = await axios.post('course-what-you-will-gets/store', itemData);
                }
