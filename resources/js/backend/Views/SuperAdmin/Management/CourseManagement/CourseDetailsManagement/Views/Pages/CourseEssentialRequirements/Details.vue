    ...
    <div class="course-what-learn-details">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="page-title mb-0">Item Details</h4>
                    </div>
                    <div class="d-flex gap-2">
                        ...
                        <router-link 
                            :to="{ name: 'CourseEssentialRequirements', params: { id: $route.params.id } }"
        ...
        <div v-else class="text-center py-5">
            <div class="alert alert-warning">
                ...
                <p class="mb-0">The requested item could not be found.</p>
                <hr>
                <div class="mb-0">
                    <router-link 
                        :to="{ name: 'CourseEssentialRequirements', params: { id: $route.params.id } }"
    ...
    setup() {
        ...
        const loadItemDetails = async () => {
            ...
            try {
                ...
                const response = await axios.get(`course-essential-requirements/${itemSlug.value}`);
        ...
        const deleteItem = async () => {
            try {
                const response = await axios.post(`course-essential-requirements/destroy/${itemSlug.value}`);
                
                if (response.data && response.data.status === 'success') {
                    window.s_alert('Item deleted successfully!', 'success');
                    
                    // Navigate back to list
                    router.push({ name: 'CourseEssentialRequirements', params: { id: route.params.id } });
                } else {
