                ...
                <form @submit.prevent="saveOverview" v-if="currentCourse">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label
                                    for="what_is_this_course"
                                    class="form-label"
                                    >What is this Course</label
                                >
                                <div
                                    class="text-editor-wrapper"
                                    :class="{
                                        'is-invalid':
                                            errors.what_is_this_course,
                                    }"
                                >
                            ...
                            <div class="form-group">
                                <label
                                    for="why_is_this_course"
                                    class="form-label"
                                    >Why this Course</label
                                >
                                <div
                                    class="text-editor-wrapper"
                                    :class="{
                                        'is-invalid': errors.why_is_this_course,
                                    }"
                                >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="sales_price" class="form-label"
                                    >Sales Price</label
                                >
                                <input
                                    type="number"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted"
                                        >Separate keywords with commas</small
                                    >
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        async saveOverview() {
            ...
            try {
                ...
                Object.keys(this.formData).forEach((key) => {
                    if (
                        key !== "image" &&
                        key !== "what_is_this_course" &&
                        key !== "why_is_this_course"
                    ) {
                ...
                const categoryInput =
                    document.getElementById("course_category_id");
                if (categoryInput) {
                    formData.set(
                        "course_category_id",
                        categoryInput.value || "",
                ...
                if (whatCourseEditor.length && whatCourseEditor.summernote) {
                    const whatCourseContent =
                        whatCourseEditor.summernote("code");
                    console.log(
                        "What is this course content:",
                        whatCourseContent,
                    );
                    formData.append(
                        "what_is_this_course",
                    ...
                    console.log(
                        "What is this course fallback content:",
                        fallbackContent,
                    );
                ...
                if (whyCourseEditor.length && whyCourseEditor.summernote) {
                    ...
                    console.log(
                        "Why this course fallback content:",
                        fallbackContent,
                    );
                    formData.append("why_is_this_course", fallbackContent);
                }

                const response = await this.updateCourse(
                ...
                if ([200, 201].includes(response.statusCode)) {
                    ...
                    const message =
                        response.message ||
                        "Course overview successfully updated";
        ...
        setImagePreview() {
            if (this.currentCourse && this.currentCourse.image) {
                console.log(
                    "Setting image preview for course image:",
            ...
            if (this.currentCourse) {
                ...
                if (whatEditor.length) {
                    if (whatEditor.summernote) {
                        whatEditor.summernote(
                            "code",
                            this.currentCourse.what_is_this_course || "",
                        );
                        console.log(
                            "Set what_is_this_course content:",
                            this.currentCourse.what_is_this_course,
                        ...
                        console.warn(
                            "Summernote not available for what_is_this_course",
                        );
                    }
                }
                ...
                if (whyEditor.length) {
                    if (whyEditor.summernote) {
                        whyEditor.summernote(
                            "code",
                            this.currentCourse.why_is_this_course || "",
                        );
                        console.log(
                            "Set why_is_this_course content:",
                            this.currentCourse.why_is_this_course,
                        ...
                        console.warn(
                            "Summernote not available for why_is_this_course",
                        );
                    }
                }
            }
    ...
    async mounted() {
        console.log(
            "CourseOverview mounted, currentCourse:",
            this.currentCourse,
        );
