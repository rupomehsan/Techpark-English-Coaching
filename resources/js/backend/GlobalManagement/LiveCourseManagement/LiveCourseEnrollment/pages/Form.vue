            ...
            <div class="card">
                ...
                <div class="card-body card_body_fixed_height">
                    <div class="row">
                        ...
                        /> -->
                        <live-course-drop-down-el
                            :name="'live_course_id'"
                            :multiple="false"
                            :value="item.live_course_id"
                            @change="typeof $event !== 'object' && (selected_live_course_id = $event)"
                        />
                        <live-course-batch-drop-down-el
                            :name="'batch_id'"
                            :multiple="false"
                            :value="item.batch_id"
                            :live_course_id="selected_live_course_id"
                        />
...
import LiveCourseBatchDropDownEl from "../../LiveCourseBatch/components/dropdown/DropDownEl.vue";
import LiveCourseDropDownEl from "../../LiveCourse/components/dropdown/DropDownEl.vue";
export default {
    components: {
        UserDropDownEl,
        LiveCourseBatchDropDownEl,
        LiveCourseDropDownEl,
    },
    ...
    methods: {
        ...
        set_fields: async function (id) {
            ...
            if (this.item) {
                if (this.item.live_course_id) {
                    let cid = typeof this.item.live_course_id === 'object' ? this.item.live_course_id.id : this.item.live_course_id;
                    this.selected_live_course_id = cid;
                }
