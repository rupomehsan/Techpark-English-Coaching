        ...
        <form @submit.prevent="submitHandler">
            <div class="card">
                ...
                <div class="card-body card_body_fixed_height">
                    <div class="row">
                    <our-video-category-drop-down-el :name="'video_category_id'" :multiple="false" :value="item.video_category_id" />
...
import OurVideoCategoryDropDownEl from "../../OurVideoCategory/components/dropdown/DropDownEl.vue";
        export default {
        components: {OurVideoCategoryDropDownEl,        },
