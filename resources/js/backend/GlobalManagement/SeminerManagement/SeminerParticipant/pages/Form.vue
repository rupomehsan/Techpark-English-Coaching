        ...
        <form @submit.prevent="submitHandler">
            <div class="card">
                ...
                <div class="card-body card_body_fixed_height">
                    <div class="row">
                    <seminer-drop-down-el :name="'seminar_id'" :multiple="false" :value="item.seminar_id" />
...
import SeminerDropDownEl from "../../Seminer/components/dropdown/DropDownEl.vue";
        export default {
        components: {SeminerDropDownEl,        },
